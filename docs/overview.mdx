...
In CasWAF, we use [Casdoor](https://casdoor.org/) as the Identity Provider (IdP). More information of Casdoor SSO can be found [here](/docs/casdoor-sso).

## Online Demo

Here is an online demo:

- Deployed site: [https://demo.caswaf.com](https://demo.caswaf.com)
